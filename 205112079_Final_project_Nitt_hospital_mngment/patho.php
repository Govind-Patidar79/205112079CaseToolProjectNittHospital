        ...
        <div class="container">
            ...
            <header>
                <h1>National Iinstitute of Technology Trichy <span>Hospital</span></h1>
				 <br> <a href ="logout1.php"><i><b>Logout</b></i></a><br>	
                ...
                <div id="container_demo" >
                    ...
                    <div id="wrapper">
                        <div id="login" class="animate form">
							...
							<h1>NIT Trichy Pathology Center</h1><br>
...
echo "<b>Test Type</b> "." : ".$res['ttype']."<br>"; 
echo "<b>Doctor Description</b>"." : ".$res['td']."<br>";
?>
...
<br><b>Upload Laboratory Report Of Patient:<br>

<input type='file' name='myfile'>
<p class="login button"> <input type='submit' value='Upload'></p>
<?php
}
else
{
