            ...
            <section>				
                ...
                <div id="container_demo" >
                    ...
                    <div id="wrapper">
						...
						<h1>Patient Test</h1><br>
						<br> <a href ="patient.php"><i><b>Back</b></i></a><br>
						<br> <a href ="logout.php"><i><b>Logout</b></i></a><br>
                            <form  action="edit1.php" method="POST" autocomplete="on"> 
                     Patient ID: <input type="text" name="rn" required="required" 

placeholder=" For eg. 205112079"/><br>        
Test Type:<br> <input type="text" name="tty" /><br><br>
Test Description<br>
           <textarea cols="50" rows="5" name="tdes" /> </textarea><br><br>
