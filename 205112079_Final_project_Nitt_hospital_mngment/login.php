                ...
                <div id="container_demo" >
                    ...
                    <div id="wrapper">
                        <div id="login" class="animate form">
                            <form  action="patient.php" method="POST" autocomplete="on"> 
                                <h1>Log in</h1> 
                                <p> 
                                    <label for="username" class="uname" data-icon="u" > Enter Your Roll Nmber </label>
...
<?php if(isset($_SESSION['fail'])) {echo "<b>Does not exist";}unset($_SESSION['fail']); if(isset($_SESSION['regsuccess'])) {echo "registration successful";}unset($_SESSION['regsuccess']); ?>									
