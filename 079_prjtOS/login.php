...
<?php if(isset($_SESSION['fail'])) {echo "Does not exist";}unset($_SESSION['fail']); if(isset($_SESSION['regsuccess'])) {echo "registration successful";}unset($_SESSION['regsuccess']); ?>									
								</p>
                                <p class="change_link">
